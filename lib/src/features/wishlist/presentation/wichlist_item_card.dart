...
//
//     final hasPriceDrop = product.actualPrice > product.sellingPrice;
//
//     return Dismissible(
...
//         onLongPress: () => _showActions(context, wishlist),
//         child: Container(
...
//
//   /// Long-press actions
//   void _showActions(BuildContext context, WishlistNotifier wishlist) {
